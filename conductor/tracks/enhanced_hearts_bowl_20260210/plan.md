...
- [ ] Task: Update Heart Geometry to Smooth Normals
    - [ ] Modify heart creation logic to compute or use smooth vertex normals.
    - [ ] Verify visual appearance in scene (smooth vs. faceted).
